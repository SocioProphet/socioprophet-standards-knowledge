...
- SHIR: proofpack and Stele outputs SHOULD remain compatible with the semantic-hyperknowledge receipt trajectory before broader lowering or export.
...
- `data/drive_activity_reporting_demo.csv` or an equivalent supported demo binding
...
- Google Sheets adapter execution path; v0.1 SHOULD start with an already-supported demo binding engine
